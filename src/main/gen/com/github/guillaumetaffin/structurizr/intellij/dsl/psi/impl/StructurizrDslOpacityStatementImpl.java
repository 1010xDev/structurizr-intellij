...
public class StructurizrDslOpacityStatementImpl extends ASTWrapperPsiElement implements StructurizrDslOpacityStatement {

  public StructurizrDslOpacityStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitOpacityStatement(this);
  }
