...
public class StructurizrDslThemesStatementImpl extends ASTWrapperPsiElement implements StructurizrDslThemesStatement {

  public StructurizrDslThemesStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitThemesStatement(this);
  }
