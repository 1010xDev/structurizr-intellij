...
public class StructurizrDslThicknessStatementImpl extends ASTWrapperPsiElement implements StructurizrDslThicknessStatement {

  public StructurizrDslThicknessStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitThicknessStatement(this);
  }
