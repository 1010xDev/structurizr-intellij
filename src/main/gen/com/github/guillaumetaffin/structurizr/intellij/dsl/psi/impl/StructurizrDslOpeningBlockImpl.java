...
public class StructurizrDslOpeningBlockImpl extends ASTWrapperPsiElement implements StructurizrDslOpeningBlock {

  public StructurizrDslOpeningBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitOpeningBlock(this);
  }
