...
public class StructurizrDslDefaultStatementImpl extends ASTWrapperPsiElement implements StructurizrDslDefaultStatement {

  public StructurizrDslDefaultStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
