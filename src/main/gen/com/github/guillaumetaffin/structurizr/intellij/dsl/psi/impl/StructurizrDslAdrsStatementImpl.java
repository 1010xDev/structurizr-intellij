...
public class StructurizrDslAdrsStatementImpl extends ASTWrapperPsiElement implements StructurizrDslAdrsStatement {

  public StructurizrDslAdrsStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitAdrsStatement(this);
  }
