...
public class StructurizrDslAnimationStepImpl extends ASTWrapperPsiElement implements StructurizrDslAnimationStep {

  public StructurizrDslAnimationStepImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitAnimationStep(this);
  }
