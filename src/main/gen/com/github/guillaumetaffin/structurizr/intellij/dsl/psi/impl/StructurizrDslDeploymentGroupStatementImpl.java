...
public class StructurizrDslDeploymentGroupStatementImpl extends ASTWrapperPsiElement implements StructurizrDslDeploymentGroupStatement {

  public StructurizrDslDeploymentGroupStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitDeploymentGroupStatement(this);
  }
