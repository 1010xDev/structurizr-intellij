...
public class StructurizrDslDocsStatementImpl extends ASTWrapperPsiElement implements StructurizrDslDocsStatement {

  public StructurizrDslDocsStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitDocsStatement(this);
  }
