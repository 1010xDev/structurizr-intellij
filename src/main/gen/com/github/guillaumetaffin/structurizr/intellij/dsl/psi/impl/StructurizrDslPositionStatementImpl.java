...
public class StructurizrDslPositionStatementImpl extends ASTWrapperPsiElement implements StructurizrDslPositionStatement {

  public StructurizrDslPositionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitPositionStatement(this);
  }
