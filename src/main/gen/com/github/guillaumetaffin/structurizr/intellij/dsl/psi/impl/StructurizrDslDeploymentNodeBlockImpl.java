...
public class StructurizrDslDeploymentNodeBlockImpl extends ASTWrapperPsiElement implements StructurizrDslDeploymentNodeBlock {

  public StructurizrDslDeploymentNodeBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitDeploymentNodeBlock(this);
  }
  ...
  @Override
  @NotNull
  public List<StructurizrDslContainerInstanceStatement> getContainerInstanceStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslContainerInstanceStatement.class);
  }

  @Override
  @NotNull
  public List<StructurizrDslDeploymentNodeStatement> getDeploymentNodeStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslDeploymentNodeStatement.class);
  }
  ...
  @Override
  @NotNull
  public List<StructurizrDslInfrastructureNodeStatement> getInfrastructureNodeStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslInfrastructureNodeStatement.class);
  }

  @Override
  @NotNull
  public List<StructurizrDslInstancesStatement> getInstancesStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslInstancesStatement.class);
  }
  ...
  @Override
  @NotNull
  public List<StructurizrDslSoftwareSystemInstanceStatement> getSoftwareSystemInstanceStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslSoftwareSystemInstanceStatement.class);
  }
