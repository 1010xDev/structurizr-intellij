...
public class StructurizrDslTerminologyStatementImpl extends ASTWrapperPsiElement implements StructurizrDslTerminologyStatement {

  public StructurizrDslTerminologyStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitTerminologyStatement(this);
  }
  ...
  @Override
  @NotNull
  public StructurizrDslTerminologyBlock getTerminologyBlock() {
    return findNotNullChildByClass(StructurizrDslTerminologyBlock.class);
  }
