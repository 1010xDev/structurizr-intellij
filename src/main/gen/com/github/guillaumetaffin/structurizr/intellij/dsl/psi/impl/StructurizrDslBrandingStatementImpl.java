...
public class StructurizrDslBrandingStatementImpl extends ASTWrapperPsiElement implements StructurizrDslBrandingStatement {

  public StructurizrDslBrandingStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitBrandingStatement(this);
  }
  ...
  @Override
  @NotNull
  public StructurizrDslBrandingBlock getBrandingBlock() {
    return findNotNullChildByClass(StructurizrDslBrandingBlock.class);
  }
