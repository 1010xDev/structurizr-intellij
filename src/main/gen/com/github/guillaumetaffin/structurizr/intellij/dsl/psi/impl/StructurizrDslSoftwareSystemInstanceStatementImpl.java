...
public class StructurizrDslSoftwareSystemInstanceStatementImpl extends ASTWrapperPsiElement implements StructurizrDslSoftwareSystemInstanceStatement {

  public StructurizrDslSoftwareSystemInstanceStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitSoftwareSystemInstanceStatement(this);
  }
  ...
  @Override
  @Nullable
  public StructurizrDslSoftwareSystemInstanceBlock getSoftwareSystemInstanceBlock() {
    return findChildByClass(StructurizrDslSoftwareSystemInstanceBlock.class);
  }
