...
public class StructurizrDslSystemContextViewStatementImpl extends ASTWrapperPsiElement implements StructurizrDslSystemContextViewStatement {

  public StructurizrDslSystemContextViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitSystemContextViewStatement(this);
  }
