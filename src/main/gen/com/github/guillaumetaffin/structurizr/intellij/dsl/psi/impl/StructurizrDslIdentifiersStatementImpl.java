...
public class StructurizrDslIdentifiersStatementImpl extends ASTWrapperPsiElement implements StructurizrDslIdentifiersStatement {

  public StructurizrDslIdentifiersStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitIdentifiersStatement(this);
  }
