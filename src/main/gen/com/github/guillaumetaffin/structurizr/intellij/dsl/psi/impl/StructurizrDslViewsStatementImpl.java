...
public class StructurizrDslViewsStatementImpl extends ASTWrapperPsiElement implements StructurizrDslViewsStatement {

  public StructurizrDslViewsStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitViewsStatement(this);
  }
  ...
  @Override
  @NotNull
  public StructurizrDslViewsBlock getViewsBlock() {
    return findNotNullChildByClass(StructurizrDslViewsBlock.class);
  }
