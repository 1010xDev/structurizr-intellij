...
public class StructurizrDslDescriptionStatementImpl extends ASTWrapperPsiElement implements StructurizrDslDescriptionStatement {

  public StructurizrDslDescriptionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitDescriptionStatement(this);
  }
