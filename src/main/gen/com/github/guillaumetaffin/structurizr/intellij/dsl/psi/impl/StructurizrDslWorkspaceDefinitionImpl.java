...
public class StructurizrDslWorkspaceDefinitionImpl extends ASTWrapperPsiElement implements StructurizrDslWorkspaceDefinition {

  public StructurizrDslWorkspaceDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitWorkspaceDefinition(this);
  }
  ...
  public StructurizrDslAName getAName() {
    return findChildByClass(StructurizrDslAName.class);
  }
