...
public class StructurizrDslDeploymentEnvironmentStatementImpl extends ASTWrapperPsiElement implements StructurizrDslDeploymentEnvironmentStatement {

  public StructurizrDslDeploymentEnvironmentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitDeploymentEnvironmentStatement(this);
  }
  ...
  @Override
  @NotNull
  public StructurizrDslDeploymentEnvironmentBlock getDeploymentEnvironmentBlock() {
    return findNotNullChildByClass(StructurizrDslDeploymentEnvironmentBlock.class);
  }
