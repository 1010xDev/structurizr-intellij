...
public class StructurizrDslTitleStatementImpl extends ASTWrapperPsiElement implements StructurizrDslTitleStatement {

  public StructurizrDslTitleStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitTitleStatement(this);
  }
