...
public class StructurizrDslHealthCheckStatementImpl extends ASTWrapperPsiElement implements StructurizrDslHealthCheckStatement {

  public StructurizrDslHealthCheckStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitHealthCheckStatement(this);
  }
