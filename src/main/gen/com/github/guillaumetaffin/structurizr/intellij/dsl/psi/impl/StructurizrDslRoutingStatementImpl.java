...
public class StructurizrDslRoutingStatementImpl extends ASTWrapperPsiElement implements StructurizrDslRoutingStatement {

  public StructurizrDslRoutingStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitRoutingStatement(this);
  }
