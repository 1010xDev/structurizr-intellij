...
public class StructurizrDslThemeStatementImpl extends ASTWrapperPsiElement implements StructurizrDslThemeStatement {

  public StructurizrDslThemeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitThemeStatement(this);
  }
