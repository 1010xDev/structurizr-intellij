...
public class StructurizrDslIncludeRelationshipStatementImpl extends ASTWrapperPsiElement implements StructurizrDslIncludeRelationshipStatement {

  public StructurizrDslIncludeRelationshipStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitIncludeRelationshipStatement(this);
  }
