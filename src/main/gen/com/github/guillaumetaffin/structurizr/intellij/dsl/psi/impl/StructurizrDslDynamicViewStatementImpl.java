...
public class StructurizrDslDynamicViewStatementImpl extends ASTWrapperPsiElement implements StructurizrDslDynamicViewStatement {

  public StructurizrDslDynamicViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitDynamicViewStatement(this);
  }
  ...
  @Override
  @Nullable
  public StructurizrDslDynamicViewBlock getDynamicViewBlock() {
    return findChildByClass(StructurizrDslDynamicViewBlock.class);
  }
