...
public class StructurizrDslDashedStatementImpl extends ASTWrapperPsiElement implements StructurizrDslDashedStatement {

  public StructurizrDslDashedStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitDashedStatement(this);
  }
