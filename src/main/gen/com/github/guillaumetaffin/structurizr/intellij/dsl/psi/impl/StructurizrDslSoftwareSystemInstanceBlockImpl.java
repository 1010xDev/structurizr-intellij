...
public class StructurizrDslSoftwareSystemInstanceBlockImpl extends ASTWrapperPsiElement implements StructurizrDslSoftwareSystemInstanceBlock {

  public StructurizrDslSoftwareSystemInstanceBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitSoftwareSystemInstanceBlock(this);
  }
