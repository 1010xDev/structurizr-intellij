...
public class StructurizrDslPersonBlockImpl extends ASTWrapperPsiElement implements StructurizrDslPersonBlock {

  public StructurizrDslPersonBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitPersonBlock(this);
  }
