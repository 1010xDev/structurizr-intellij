...
public class StructurizrDslClosingBlockImpl extends ASTWrapperPsiElement implements StructurizrDslClosingBlock {

  public StructurizrDslClosingBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitClosingBlock(this);
  }
