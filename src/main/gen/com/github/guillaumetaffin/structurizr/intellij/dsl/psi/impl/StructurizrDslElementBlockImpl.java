...
public class StructurizrDslElementBlockImpl extends ASTWrapperPsiElement implements StructurizrDslElementBlock {

  public StructurizrDslElementBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
