...
public class StructurizrDslComponentBlockImpl extends ASTWrapperPsiElement implements StructurizrDslComponentBlock {

  public StructurizrDslComponentBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
