...
public class StructurizrDslShapeStatementImpl extends ASTWrapperPsiElement implements StructurizrDslShapeStatement {

  public StructurizrDslShapeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
