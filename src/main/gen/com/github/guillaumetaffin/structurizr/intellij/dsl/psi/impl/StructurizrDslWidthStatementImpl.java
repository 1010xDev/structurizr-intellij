...
public class StructurizrDslWidthStatementImpl extends ASTWrapperPsiElement implements StructurizrDslWidthStatement {

  public StructurizrDslWidthStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitWidthStatement(this);
  }
