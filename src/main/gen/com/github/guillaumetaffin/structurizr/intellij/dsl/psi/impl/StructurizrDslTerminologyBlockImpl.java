...
public class StructurizrDslTerminologyBlockImpl extends ASTWrapperPsiElement implements StructurizrDslTerminologyBlock {

  public StructurizrDslTerminologyBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitTerminologyBlock(this);
  }
