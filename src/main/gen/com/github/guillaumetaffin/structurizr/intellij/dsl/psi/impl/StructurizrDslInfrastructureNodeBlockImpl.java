...
public class StructurizrDslInfrastructureNodeBlockImpl extends ASTWrapperPsiElement implements StructurizrDslInfrastructureNodeBlock {

  public StructurizrDslInfrastructureNodeBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitInfrastructureNodeBlock(this);
  }
