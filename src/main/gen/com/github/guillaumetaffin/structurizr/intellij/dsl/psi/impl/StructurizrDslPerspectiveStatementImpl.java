...
public class StructurizrDslPerspectiveStatementImpl extends ASTWrapperPsiElement implements StructurizrDslPerspectiveStatement {

  public StructurizrDslPerspectiveStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitPerspectiveStatement(this);
  }
