...
public class StructurizrDslContainerViewStatementImpl extends ASTWrapperPsiElement implements StructurizrDslContainerViewStatement {

  public StructurizrDslContainerViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitContainerViewStatement(this);
  }
