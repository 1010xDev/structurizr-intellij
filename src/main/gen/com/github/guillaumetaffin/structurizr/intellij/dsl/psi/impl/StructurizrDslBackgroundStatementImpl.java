...
public class StructurizrDslBackgroundStatementImpl extends ASTWrapperPsiElement implements StructurizrDslBackgroundStatement {

  public StructurizrDslBackgroundStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitBackgroundStatement(this);
  }
