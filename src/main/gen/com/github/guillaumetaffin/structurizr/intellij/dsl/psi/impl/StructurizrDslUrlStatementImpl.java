...
public class StructurizrDslUrlStatementImpl extends ASTWrapperPsiElement implements StructurizrDslUrlStatement {

  public StructurizrDslUrlStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitUrlStatement(this);
  }
