...
public class StructurizrDslANameImpl extends ASTWrapperPsiElement implements StructurizrDslAName {

  public StructurizrDslANameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitAName(this);
  }
