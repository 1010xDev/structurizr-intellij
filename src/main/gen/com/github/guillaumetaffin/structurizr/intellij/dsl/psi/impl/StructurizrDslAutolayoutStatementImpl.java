...
public class StructurizrDslAutolayoutStatementImpl extends ASTWrapperPsiElement implements StructurizrDslAutolayoutStatement {

  public StructurizrDslAutolayoutStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitAutolayoutStatement(this);
  }
