...
public class StructurizrDslColorStatementImpl extends ASTWrapperPsiElement implements StructurizrDslColorStatement {

  public StructurizrDslColorStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitColorStatement(this);
  }
