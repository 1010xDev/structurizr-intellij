...
public class StructurizrDslSoftwareSystemBlockImpl extends ASTWrapperPsiElement implements StructurizrDslSoftwareSystemBlock {

  public StructurizrDslSoftwareSystemBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitSoftwareSystemBlock(this);
  }
