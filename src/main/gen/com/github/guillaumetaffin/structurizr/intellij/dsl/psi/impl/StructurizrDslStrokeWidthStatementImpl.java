...
public class StructurizrDslStrokeWidthStatementImpl extends ASTWrapperPsiElement implements StructurizrDslStrokeWidthStatement {

  public StructurizrDslStrokeWidthStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitStrokeWidthStatement(this);
  }
