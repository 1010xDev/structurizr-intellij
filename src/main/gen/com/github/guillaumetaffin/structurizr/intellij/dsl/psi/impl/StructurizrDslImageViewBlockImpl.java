...
public class StructurizrDslImageViewBlockImpl extends ASTWrapperPsiElement implements StructurizrDslImageViewBlock {

  public StructurizrDslImageViewBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitImageViewBlock(this);
  }
