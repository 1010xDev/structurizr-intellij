...
public class StructurizrDslDeploymentEnvironmentBlockImpl extends ASTWrapperPsiElement implements StructurizrDslDeploymentEnvironmentBlock {

  public StructurizrDslDeploymentEnvironmentBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitDeploymentEnvironmentBlock(this);
  }
  ...
  @Override
  @NotNull
  public List<StructurizrDslDeploymentGroupStatement> getDeploymentGroupStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslDeploymentGroupStatement.class);
  }
