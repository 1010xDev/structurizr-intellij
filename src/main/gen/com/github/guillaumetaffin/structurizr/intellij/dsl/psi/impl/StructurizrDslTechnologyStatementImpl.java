...
public class StructurizrDslTechnologyStatementImpl extends ASTWrapperPsiElement implements StructurizrDslTechnologyStatement {

  public StructurizrDslTechnologyStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitTechnologyStatement(this);
  }
