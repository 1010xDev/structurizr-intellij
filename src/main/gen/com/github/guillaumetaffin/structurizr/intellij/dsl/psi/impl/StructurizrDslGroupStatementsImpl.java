...
public class StructurizrDslGroupStatementsImpl extends ASTWrapperPsiElement implements StructurizrDslGroupStatements {

  public StructurizrDslGroupStatementsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitGroupStatements(this);
  }
