...
public class StructurizrDslLogoStatementImpl extends ASTWrapperPsiElement implements StructurizrDslLogoStatement {

  public StructurizrDslLogoStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitLogoStatement(this);
  }
