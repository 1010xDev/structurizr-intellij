...
public class StructurizrDslStrokeStatementImpl extends ASTWrapperPsiElement implements StructurizrDslStrokeStatement {

  public StructurizrDslStrokeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitStrokeStatement(this);
  }
