...
public class StructurizrDslPropertiesStatementImpl extends ASTWrapperPsiElement implements StructurizrDslPropertiesStatement {

  public StructurizrDslPropertiesStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StructurizrDslPropertyStatement> getPropertyStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslPropertyStatement.class);
  }
