...
public class StructurizrDslStylesBlockImpl extends ASTWrapperPsiElement implements StructurizrDslStylesBlock {

  public StructurizrDslStylesBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitStylesBlock(this);
  }
  ...
  @Override
  @NotNull
  public List<StructurizrDslElementStyle> getElementStyleList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslElementStyle.class);
  }
  ...
  @Override
  @NotNull
  public List<StructurizrDslRelationshipStyle> getRelationshipStyleList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslRelationshipStyle.class);
  }
