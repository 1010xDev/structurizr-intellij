...
public class StructurizrDslCustomViewStatementImpl extends ASTWrapperPsiElement implements StructurizrDslCustomViewStatement {

  public StructurizrDslCustomViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitCustomViewStatement(this);
  }
