...
public class StructurizrDslSoftwareSystemStatementImpl extends ASTWrapperPsiElement implements StructurizrDslSoftwareSystemStatement {

  public StructurizrDslSoftwareSystemStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitSoftwareSystemStatement(this);
  }
  ...
  @Override
  @Nullable
  public StructurizrDslSoftwareSystemBlock getSoftwareSystemBlock() {
    return findChildByClass(StructurizrDslSoftwareSystemBlock.class);
  }
