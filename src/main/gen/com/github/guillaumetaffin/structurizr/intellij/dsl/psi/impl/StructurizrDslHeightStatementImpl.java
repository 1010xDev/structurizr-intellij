...
public class StructurizrDslHeightStatementImpl extends ASTWrapperPsiElement implements StructurizrDslHeightStatement {

  public StructurizrDslHeightStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitHeightStatement(this);
  }
