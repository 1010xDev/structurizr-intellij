...
public class StructurizrDslBorderStatementImpl extends ASTWrapperPsiElement implements StructurizrDslBorderStatement {

  public StructurizrDslBorderStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitBorderStatement(this);
  }
