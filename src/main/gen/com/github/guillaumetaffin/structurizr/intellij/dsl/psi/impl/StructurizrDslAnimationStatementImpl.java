...
public class StructurizrDslAnimationStatementImpl extends ASTWrapperPsiElement implements StructurizrDslAnimationStatement {

  public StructurizrDslAnimationStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StructurizrDslAnimationStep> getAnimationStepList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StructurizrDslAnimationStep.class);
  }
