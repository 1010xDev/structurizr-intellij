...
public class StructurizrDslInstancesStatementImpl extends ASTWrapperPsiElement implements StructurizrDslInstancesStatement {

  public StructurizrDslInstancesStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitInstancesStatement(this);
  }
