...
public class StructurizrDslLhsRelationStatementImpl extends ASTWrapperPsiElement implements StructurizrDslLhsRelationStatement {

  public StructurizrDslLhsRelationStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitLhsRelationStatement(this);
  }
