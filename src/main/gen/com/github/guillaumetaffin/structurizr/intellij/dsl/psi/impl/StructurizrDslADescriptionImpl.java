...
public class StructurizrDslADescriptionImpl extends ASTWrapperPsiElement implements StructurizrDslADescription {

  public StructurizrDslADescriptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrDslVisitor visitor) {
    visitor.visitADescription(this);
  }
